function getWeekNumber(date) 
{
  ...
  class Day {
    ...
    format(formatStr) {
      return formatStr
        ...
        .replace(/\bDD\b/, this.date.toString().padStart(2))
  ...
  class DatePicker extends HTMLElement {
    ...
    constructor() {
      ...
      const lang = "en";//window.navigator.language;
    ...
    connectedCallback() {
      ...
      this.toggleButtonIcon = this.shadow.querySelector('.date-toggle1');
      ...
      this.toggleButtonIcon.addEventListener('click', () => this.toggleCalendar());
    ...
    updateToggleText() {
      ...
      var icon = new Image();
      icon.src = './calendar-alt.svg';
      this.toggleButton.textContent = date;
      this.toggleButtonIcon.src = icon.src;
      this.toggleButtonIcon.style.marginLeft = "72.06%";
    }
    ...
    render() {
      ...
      this.shadow.innerHTML = `
        ...
        <div class = "button-date">
          ...
          <button type="button" class="date-toggle1"><img src="calendar-alt.svg" width="25px" height="22px"></button>
        </div>
